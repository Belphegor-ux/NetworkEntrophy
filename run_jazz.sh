...
echo "Spawning parallel agents for Jazz benchmarks..."
...
gemini-flow agent spawn worker --objective "cd Jazz/ME && python ME_mapping_entropy.py && python iterative_me.py" --gemini &

echo "Waiting for all Jazz agents to finish..."
wait
echo "Jazz benchmarks completed! Results are in Jazz/[Method]/results/"
